...
public class ListViewSwipeGesture implements View.OnTouchListener {
    ...
    private void GetResourcesValues() {
        ...
        HalfColor           =   RangeOneColor;          //red
        HalfText            =   activity.getResources().getString(R.string.delete_action);
        HalfTextFinal         =   activity.getResources().getString(R.string.delete_action);
        HalfDrawable        =   activity.getResources().getDrawable( R.drawable.ic_close );
    }
    ...
    public boolean onTouch(final View view, MotionEvent event) {
        if (mViewWidth < 2) {
            ...
            textwidth2	=	mViewWidth/6;
            textwidth	=	textwidth2;
            largewidth	=	textwidth+textwidth2;
            smallWidth	=	2*textwidth2;
        }
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (rect.contains(x, y)) {
                        ...
                        mDownView           =   (ViewGroup) child.findViewById(R.id.pendingInspectionRowLinearLayout);
