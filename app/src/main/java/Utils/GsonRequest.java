...
/**
 * Created by kaleem.patel on 7/7/2015.
 */
public class GsonRequest<T> extends Request<T> {
        ...
        public static Cache.Entry parseIgnoreCacheHeaders (NetworkResponse response) {
                ...
                final long cacheHitButRefreshed = 10 * 60 * 1000; // in 10 minutes cache will be
                // hit, but also refreshed on background
                final long cacheExpired = 500 * 60 * 60 * 1000; // in 500 hours this cache entry
                // expires completely
